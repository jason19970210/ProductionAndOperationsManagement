...
8. (23)D公司生產桌上型電腦、筆記型電腦與平板電腦三種產品。依過去經驗得知表面黏著技術製程為其生產的關鍵資源，且每周最多能提供70000分鐘之工時。已知其未來八週三種產品的MPS如下所示。每臺桌上型電腦、筆記型電腦與平板電腦需要表面黏著技術製程的工時為1.5分鐘、2分鐘與3分鐘。試問目前所規劃出的MPS是否可行？
- D公司MPS
